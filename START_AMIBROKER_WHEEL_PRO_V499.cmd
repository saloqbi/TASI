@echo off
title AmiBroker Wheel Professional Link V499
setlocal
set "PSFILE=%TEMP%\amibroker_wheel_professional_v499.ps1"
set "WHEEL=https://htmlpreview.github.io/?https://github.com/saloqbi/TASI/blob/main/public/kawkabat-al-arqam-al-sihria-v499-amibroker-professional-clean.html"
taskkill /FI "WINDOWTITLE eq AmiBroker Gold Bridge*" /T /F >nul 2>&1
taskkill /FI "WINDOWTITLE eq AmiBroker Wheel Professional Link*" /T /F >nul 2>&1
...
if errorlevel 1 (echo Failed to download V499 bridge.&pause&exit /b 1)
start "AmiBroker Wheel Professional Link V499" powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -NoExit -File "%PSFILE%" -Port 8768 -Symbol XAUUSD
